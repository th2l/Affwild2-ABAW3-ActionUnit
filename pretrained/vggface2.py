"""
Adopted from https://github.com/cydonia999/VGGFace2-pytorch
"""
import torch
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.se:
            ...
            out2 = torch.mean(out, dim=(2, 3), keepdim=True)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, include_top=True, se=False):
        self.se = se
        self.inplanes = 64
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1)) # AvgPool2d(7, stride=1)
