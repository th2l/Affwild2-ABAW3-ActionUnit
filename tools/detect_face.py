"""
Adopted from facenet-pytorch@timesler
https://raw.githubusercontent.com/timesler/facenet-pytorch/master/models/utils/detect_face.py
"""
...
def crop_resize(img, box, image_size, left_eye=None, right_eye=None, align=False):
    if isinstance(img, np.ndarray):
        ...
        print('Do not support align for PIL image')
...
def alignment_procedure(img, left_eye, right_eye):
    ...
    Adopted from https://github.com/serengil/deepface/blob/master/deepface/detectors/FaceDetector.py#L68-113
    :param img:
    :param left_eye:
    :param right_eye:
    :return:
...
def extract_face(img, box, image_size=160, margin=0, save_path=None, left_eye=None, right_eye=None, align=False, to_tensor=False):
    ...
    """
    if align and (left_eye is None or right_eye is None):
        raise ValueError('To align face, we need left eye and right eye location.')
    ...
    face = crop_resize(img, box, image_size, left_eye=left_eye, right_eye=right_eye, align=align)
