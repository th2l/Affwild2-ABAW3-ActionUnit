...
https://raw.githubusercontent.com/timesler/facenet-pytorch/master/models/mtcnn.py
"""
...
class MTCNN(nn.Module):
    ...
    def forward(self, img, save_path=None, return_prob=False):
        ...
        # Extract faces
        faces = self.extract(img, batch_boxes, save_path, left_eyes=batch_points[:, 0, :], right_eyes=batch_points[:, 1, :])
    ...
    def extract(self, img, batch_boxes, save_path, left_eyes, right_eyes):
        ...
        faces = []
        for im, box_im, path_im, left_eye, right_eye in zip(img, batch_boxes, save_path, left_eyes, right_eyes):
            if box_im is None:
                faces.append(None)
                continue
            ...
            for i, box in enumerate(box_im):
                ...
                face = extract_face(im, box, self.image_size, self.margin, face_path, left_eye=left_eye, right_eye=right_eye, align=self.align, to_tensor=self.to_tensor)
